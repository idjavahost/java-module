...
var messageTimeout,javaForm=null,showMessage=function(e,t,a){clearTimeout(messageTimeout);var i=$("div.java-tab-container .message-wrap"),s="number"==typeof a?1e3*a:5e3;i.find(".alert").length&&i.find(".alert").slideUp(),void 0===e&&(e="success");var n='<div class="alert alert-dismissible alert-'+e+'">';n+='<button type="button" class="close" data-dismiss="alert" aria-label="Close">',n+='<span aria-hidden="true">&times;</span></button>',n+="<p>"+t+"</p></div>",i.html(n),i.find(".alert").slideDown(),messageTimeout=setTimeout(function(){i.find(".alert").slideUp()},s)};$.fn.serializeObject=function(){var s=this,n={},t={},r={validate:/^[a-zA-Z][a-zA-Z0-9_]*(?:\[(?:\d*|[a-zA-Z0-9_]+)\])*$/,key:/[a-zA-Z0-9_]+|(?=\[\])/g,push:/^$/,fixed:/^\d+$/,named:/^[a-zA-Z0-9_]+$/};return this.build=function(e,t,a){return e[t]=a,e},this.push_counter=function(e){return t[e]===undefined&&(t[e]=0),t[e]++},$.each($(this).serializeArray(),function(){if(r.validate.test(this.name)){for(var e,t=this.name.match(r.key),a=this.value,i=this.name;(e=t.pop())!==undefined;)i=i.replace(new RegExp("\\["+e+"\\]$"),""),e.match(r.push)?a=s.build([],s.push_counter(i),a):e.match(r.fixed)?a=s.build([],e,a):e.match(r.named)&&(a=s.build({},e,a));n=$.extend(!0,n,a)}}),n},$.fn.sortable=function(e){var t=new Sortable(this,"object"==typeof e?e:{});return $(this).data("sortable",t),this};
$(function(){function i(a){var t=void 0!==a?a:"#java-options-form";$(t+" .help-tip").popover({html:!0,animation:!0,container:t,placement:"left",trigger:"click"}),$(t+" .colorpicker-component").each(function(){var a={},e=$(this).attr("data-config");e&&(a=JSON.parse(e));$(t);$(this).colorpicker(a)}),$(t+" textarea.wysihtml").each(function(){var a,e=$(this).attr("data-config");a=e?JSON.parse(e):{"font-styles":!1,image:!1,blockquote:!1,link:!1,lists:!1},$(this).wysihtml5({toolbar:a})}),$(t+" .form-group select").each(function(){!$(this).hasClass("inited")&&$(this).is(":visible")&&($(this).addClass("inited"),$(this).select2())}),$(t+" input.bootstrap-slider").each(function(){var e=$(this).data("slider-id")+"-value";$(this).bootstrapSlider(),$(this).on("slide",function(a){$("span#"+e).text(a.value)})}),$(t+" .dm-uploader").each(function(){var s=$(this),a=s.data("options"),e={multiple:!1,allowedTypes:"image/*",onDragEnter:function(){s.addClass("active")},onDragLeave:function(){s.removeClass("active")},onNewFile:function(a,e){if(s.find("img").length&&"undefined"!=typeof FileReader){var t=new FileReader,i=s.find("img");t.onload=function(a){i.attr("src",a.target.result)},t.readAsDataURL(e)}},onBeforeUpload:function(a){s.find(".btn-sm").prop("disabled",!0),$("#java-options-form").find("button[type=submit]").prop("disabled",!0)},onComplete:function(){s.find(".btn-sm").prop("disabled",!1),$("#java-options-form").find("button[type=submit]").prop("disabled",!1)},onUploadSuccess:function(a,e){if("fail"==e.status){var t=e.message?", "+e.message:"!";showMessage("danger","Upload gagal"+t)}else if(e.data){var i=e.data;s.find('input[type="text"]').val(i.rel_path+"/"+i.file_name),showMessage("success","Upload berhasil, jangan lupa untuk menyimpan pengaturan!",10)}}};$.extend(e,a),s.dmUploader(e)}),window.javaForm.resetForm()}$.fn.select2.defaults.reset(),$.fn.select2.defaults.set("theme","bootstrap"),$.fn.select2.defaults.set("language","id"),$.fn.select2.defaults.set("width","100%"),$.fn.select2.defaults.set("minimumResultsForSearch",Infinity),$("html").on("mouseup",function(a){$(a.target).closest(".popover").length||$("[data-original-title]").popover("hide")}),$(document).on("click",".dm-uploader img.img-preview",function(a){var e=$(a.target).attr("src"),t=$(".modal-java-preview");e&&t.length&&(t.find("img").attr("src",e),t.modal("show"))}),$("div.java-tab-menu>div.list-group>a").click(function(a){a.preventDefault(),$(this).siblings("a.active").removeClass("active"),$(this).addClass("active");var e=$(this).index(),t=$(this)[0].hash;$("div.java-tab>div.java-tab-content").removeClass("active"),$("div.java-tab>div.java-tab-content").eq(e).addClass("active"),history.pushState?history.pushState(null,null,t):location.hash=t,s($(t).height()+95),i(t)}),""!==window.location.hash&&$(window.location.hash).length&&($("div.java-tab-menu>div.list-group>a").removeClass("active"),$('div.java-tab-menu>div.list-group>a[href="'+window.location.hash+'"]').addClass("active"),$("div.java-tab>div.java-tab-content").removeClass("active"),$("div.java-tab>div"+window.location.hash).addClass("active")),window.javaForm=$("#java-options-form").validate({errorElement:"small",errorClass:"help-block",highlight:function(a){$(a).closest(".form-group").addClass("has-error")},unhighlight:function(a){$(a).closest(".form-group").removeClass("has-error")},submitHandler:function(a){var e="Ups! Terjadi kesalahan, gagal menyimpan konfigurasi.";$(".java-tab-container").addClass("is-loading");try{var t=$(a).serializeObject();$.post(a.action,t,function(a){if(a.success)showMessage("success",'Pengaturan berhasil di simpan! <a href="/first" target="_blank">Lihat Website</a>');else{a.message&&a.message;showMessage("danger",e)}$(".java-tab-container").removeClass("is-loading")},"json")}catch(i){$(".java-tab-container").removeClass("is-loading"),showMessage("danger",e),console.log(i)}return!1}});var s=function(a){var e=$(".java-tab-content.active").height()+95,t=$("div.java-tab-menu div.list-group").height(),i=void 0===a?e:a<e?e:a;i<t&&(i=t),$(".java-tab-menu,.java-tab").css({"min-height":i+"px"})};$(window).resize(function(){s()}),$(".java-tab-container").removeClass("is-loading"),s(),i()});
